        ...
        <AnimatePresence>
          {toasts.map((toast) => (
            <motion.div
              ...
              className="pointer-events-auto flex items-center justify-between p-4 rounded-2xl shadow-2xl border border-slate-800 bg-slate-950/95 backdrop-blur-md text-white"
            >
